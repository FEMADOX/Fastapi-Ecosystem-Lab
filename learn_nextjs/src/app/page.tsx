...
const HomePage = () => {
  return (
    <section className="relative isolate overflow-hidden rounded-2xl border border-border bg-card p-5 sm:rounded-3xl sm:p-8 lg:p-12">
      <div
        aria-hidden
      ...
      <div className="relative flex flex-col gap-8 sm:gap-10">
        <div className="space-y-5">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <Link
              href="/items"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-80"
            >
              Explore Items
